...
/// Provide a vhost-user-user back-end for front-end testing.
///
/// Set up a `MockVhostBackend` vhost-user-user back-end and run `cb` in a thread, passing the
/// vhost-user-user socket's path and a barrier to await request processing.  `cb` is supposed to run
/// the front-end tests.
///
