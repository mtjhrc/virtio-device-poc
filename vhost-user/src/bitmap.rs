...
/// The main use case is to support live migration on vhost-user-user backends
/// (see `VHOST_USER_PROTOCOL_F_LOG_SHMFD` and `VHOST_USER_SET_LOG_BASE` in the vhost-user-user protocol
...
/// and set operations. The main use case is to support live migration on vhost-user-user backends
/// (see `VHOST_USER_PROTOCOL_F_LOG_SHMFD` and `VHOST_USER_SET_LOG_BASE` in the vhost-user-user protocol
